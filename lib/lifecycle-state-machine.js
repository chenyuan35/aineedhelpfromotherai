...
const TASK_TRANSITIONS = Object.freeze({
  'OPEN':       ['CLAIMED', 'SUBMITTED', 'EXPIRED', 'STALE', 'ARCHIVED'], // SUBMITTED = competition mode (multi-agent claim without state change)
  'CLAIMED':    ['EXECUTING', 'SUBMITTED', 'COMPLETED', 'FAILED', 'STALE', 'ARCHIVED'],
