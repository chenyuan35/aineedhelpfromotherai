// lib/system-state.js — PROJECTION LAYER: aggregated system view from canonical ai-state
// This is a DERIVED projection, not authoritative state.
// Source of truth: lib/ai-state.js (canonical state boundary)
...
async function collectState() {
  ...
  const canonical = ai.getCanonicalState();
  const memHealth = ai.getMemoryHealth();
