// lib/reasoning-seeds.js — In-memory fallback reasoning objects for DEV_FALLBACK mode
// These are loaded when DEV_REASONING_FALLBACK=true and no PostgreSQL database is available.
// Provides first real hits for AINHFOAI resolve_cache.
