...
| Analytics | GA4 measurement ID `G-FYKKNKRE58` is live site-wide and linked through GSC Wizard. Early zero/near-zero data is not a negative product verdict. | Once real sessions exist, separate organic, referral, AI referral and direct/repeat behavior and use first-screen/tool events to guide UX. |
...
3. **Homepage:** wait for real GA4 homepage sessions/tool-open behavior before another hero/CTA change.
