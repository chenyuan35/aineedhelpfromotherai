...
16. **NEXT SESSION — Globe Philippines packet.** Resolve whether the target user has a lawful non-tourist registration path for ordinary Globe Prepaid beyond the 30-day tourist limit and what that implies for long-term overseas SMS/OTP. Holafly Always On remains a separate backstage task; no auto-publication.
