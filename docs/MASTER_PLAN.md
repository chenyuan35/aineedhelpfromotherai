...
30. PRIMARY / ACTIVE — Continue Draft PR #62 as the main product. Finish route evidence, purchase/activation/verification/retention intelligence, release audit and manual preview gates before considering production release.
...
- Existing generic calculators/image utilities are maintenance-only; new product work goes into the phone lifecycle unless it is necessary maintenance/freshness work for Reset Radar or Relay Exit Risk.
