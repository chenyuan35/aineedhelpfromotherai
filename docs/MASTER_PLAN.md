...
15. **NEXT SESSION — watcher precision repair.** Normalize fragment-only V2EX reply URLs for dedupe while preserving genuinely new evidence; do not broadly suppress V2EX.
16. **BACKLOG — promoted Globe/Holafly packets.** Continue the two research questions only after watcher precision repair; no auto-publication.
