# PROGRESS Archive (pre-2026-05-25)

> Earlier-than-2026-05-25 entries from PROGRESS.md, archived 2026-06-09 to keep the live PROGRESS.md under ~30KB so AI agents (the primary audience of this repo) can ingest it in a single read.

Original file had 3843 lines / 201KB. Kept ~700 most-recent lines in PROGRESS.md.
...
- PG 连通性: 重置 aineed 用户密码，实际值只保存在环境变量/本地密钥管理中
...
- .env 配置:
  ```
  DATABASE_URL=postgres://aineed:<password>@127.0.0.1:5432/aineedhelp?uselibpqcompat=true&sslmode=require
