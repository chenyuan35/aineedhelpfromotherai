...
mkdirSync(dist, { recursive: true });
const files = ['index.html', 'favicon.svg', 'og-card.svg', 'hero-warm-botanical.png', 'llms.txt', 'ai.txt', 'robots.txt', 'sitemap.xml', 'feed.xml', 'failure-index.json', 'vercel.json', 'indexnow-key.txt', 'ads.txt'];
