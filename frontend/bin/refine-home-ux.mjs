...
.quick-starts-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:18px}
...
@media(max-width:1020px){.quick-starts-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
