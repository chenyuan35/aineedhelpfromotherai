...
.page{padding:72px 0 92px}.hero{display:grid;grid-template-columns:minmax(0,1fr) minmax(320px,.48fr);gap:64px;align-items:start;border-bottom:1px solid var(--line);padding-bottom:62px}.eyebrow{color:var(--accent);font-size:12px;font-weight:760;margin-bottom:18px;text-transform:uppercase}.hero h1{margin:0;max-width:820px;font-size:clamp(38px,4.8vw,66px);line-height:1.1;font-weight:760;letter-spacing:0}.lead{margin:28px 0 0;color:var(--muted);font-size:18px;line-height:1.82;max-width:700px}.side{align-self:start;background:var(--surface);border:1px solid var(--line);border-radius:8px;padding:28px}.side b{display:block;margin-bottom:12px}.side p{margin:0;color:var(--muted);font-size:15px;line-height:1.78}.side a{display:inline-flex;margin-top:20px;border:1px solid var(--ink);background:var(--ink);color:#fff;border-radius:6px;padding:11px 15px;font-size:14px;font-weight:650}
.section{display:grid;grid-template-columns:240px minmax(0,1fr);gap:60px;padding:58px 0;border-bottom:1px solid var(--line)}.section:last-of-type{border-bottom:0}h2{margin:0;font-size:23px;line-height:1.32}.body{max-width:800px;color:var(--muted);font-size:16px;line-height:1.88}.body p{margin:0}.body strong{color:var(--ink)}.cards{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}.card{background:var(--surface);border:1px solid var(--line);border-radius:8px;padding:24px;line-height:1.6}.card small{display:block;color:var(--faint);font-size:12px;margin-bottom:10px}.card strong{display:block;color:var(--ink);font-size:16px;line-height:1.38}.terminal{margin:26px 0 0;background:var(--code);color:var(--code-text);border-radius:8px;padding:24px 26px;overflow:auto;font:13px/1.82 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;tab-size:2;white-space:pre}.api-table{width:100%;border-collapse:separate;border-spacing:0;margin:20px 0 0;background:var(--surface);border:1px solid var(--line);border-radius:8px;overflow:hidden}.api-table th,.api-table td{text-align:left;padding:15px 17px;border-bottom:1px solid var(--line);font-size:13px;line-height:1.65;vertical-align:top}.api-table th{background:var(--surface-2);font-weight:700;color:var(--ink)}.api-table tr:last-child td{border-bottom:0}.api-table code{background:var(--code);color:var(--code-text);padding:3px 7px;border-radius:4px;font-size:12px;line-height:1.7}
