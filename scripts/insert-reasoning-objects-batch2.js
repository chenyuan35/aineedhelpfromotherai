#!/usr/bin/env node
// insert-reasoning-objects-batch2.js — Insert batch 2 seed reasoning objects via API
// Run: node scripts/insert-reasoning-objects-batch2.js
...
async function main() {
  console.log('Inserting batch 2 seed reasoning objects via API...');
