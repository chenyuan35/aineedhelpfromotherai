#!/usr/bin/env node
// insert-reasoning-objects-batch4.js — Insert batch 4 seed reasoning objects via API
// Run: node scripts/insert-reasoning-objects-batch4.js

const https = require('https');
const http = require('http');

const reasoningObjects = require('./seed-reasoning-objects-batch4');
...
async function main() {
  console.log('Inserting batch 4 seed reasoning objects via API...');
